...
- (void)viewDidLoad {
    ...
    self.pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:0.56 green:0.07 blue:1.00 alpha:1.0];
...
//        self.enterButton.layer.borderColor = [UIColor whiteColor].CGColor;
        ...
        [self.enterButton setImage:[UIImage imageNamed:@"getstarted"] forState:UIControlStateNormal];
